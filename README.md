...
3. Setup your `appSettings.json` file in the root directory, making sure your connection string has correct values for your user, password, and port.
...
should create and seed a database on startup in the development environment if your connection string is set up correctly. 
